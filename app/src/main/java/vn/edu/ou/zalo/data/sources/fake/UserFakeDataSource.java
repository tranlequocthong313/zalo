...
public class UserFakeDataSource implements IUserDataSource {
    ...
    @Override
    public void getUsers(Map<String, String> query, User signedInUser, IRepositoryCallback<List<User>> callback) {
