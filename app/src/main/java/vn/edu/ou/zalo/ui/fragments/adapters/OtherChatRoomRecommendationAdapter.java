...
public class OtherChatRoomRecommendationAdapter extends RecyclerView.Adapter<UnimportantChatRoomSuggestionViewHolder> {
    private final List<ChatRoom> chatRooms;

    public OtherChatRoomRecommendationAdapter(List<ChatRoom> chatRooms) {
    ...
    public UnimportantChatRoomSuggestionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_chat_recommendation, parent, false);
    ...
    public void updateRecommendation(List<ChatRoom> newSuggestions) {
