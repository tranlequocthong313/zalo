...
public class AuthRemoteDataSourceImpl implements IAuthDataSource {
    ...
    @Inject
    public AuthRemoteDataSourceImpl(FirebaseAuth auth, FirebaseFirestore db, FirebaseFunctions func) {
        this.auth = auth;
        this.db = db;
        this.func = func;
